...
Учебный проект двуязычного приложения - учебника языков программирования с интегрированными подсказками от LLM Giga Chat.
Репозиторий: https://github.com/Kiril-Bokov/function-learn
